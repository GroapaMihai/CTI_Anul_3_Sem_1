...
void SimpleScene::DrawCoordinatSystem(bool wire)
{
	DrawCoordinatSystem(camera->GetViewMatrix(), camera->GetProjectionMatrix(), wire);
}

void SimpleScene::DrawCoordinatSystem(const glm::mat4 & viewMatrix, const glm::mat4 & projectionMaxtix, bool wire)
{
	glLineWidth(1);
